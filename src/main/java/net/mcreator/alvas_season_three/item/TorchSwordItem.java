...
public class TorchSwordItem extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:torch_sword")
	public static final Item block = null;

	public TorchSwordItem(AlvasSeason3ModElements instance) {
		super(instance, 11);
	}
