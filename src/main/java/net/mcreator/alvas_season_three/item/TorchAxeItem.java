...
public class TorchAxeItem extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:torch_axe")
	public static final Item block = null;

	public TorchAxeItem(AlvasSeason3ModElements instance) {
		super(instance, 10);
	}
