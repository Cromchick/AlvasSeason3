...
public class TorchShovelItem extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:torch_shovel")
	public static final Item block = null;

	public TorchShovelItem(AlvasSeason3ModElements instance) {
		super(instance, 12);
	}
